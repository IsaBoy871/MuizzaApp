    ...
    public class NavigationService : INavigationService
    {
        ...
        protected static INavigation Navigation
        {
            get
            {
                ...
                if (DeviceInfo.Platform == DevicePlatform.iOS && !OperatingSystem.IsIOSVersionAtLeast(11))
                {
                    throw new PlatformNotSupportedException("Navigation requires iOS 11.0 or later");
                }
